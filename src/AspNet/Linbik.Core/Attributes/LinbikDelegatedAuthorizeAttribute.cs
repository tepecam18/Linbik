...
/// </summary>
public sealed class LinbikDelegatedAuthorizeAttribute : AuthorizeAttribute
{
    public LinbikDelegatedAuthorizeAttribute()
    {
        AuthenticationSchemes = LinbikDefaults.DelegatedScheme;
    }
}
